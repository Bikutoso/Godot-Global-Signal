...
func _connect_emitter_to_listeners(signal_name: String, emitter: Object) -> void:
	var listeners: Dictionary = _listeners[signal_name]
	for listener: Dictionary in listeners.values():
...
func _connect_listener_to_emitters(signal_name: String, listener: Object, method: String) -> void:
	var emitters: Dictionary = _emitters[signal_name]
	for emitter: Dictionary in emitters.values():
...
func _process_emit_queue() -> void:
	for emitted_signal: Dictionary in _emit_queue:
...
func add_emitter(signal_name: String, emitter: Object) -> void:
	var emitter_data: Dictionary = { "object": emitter, "object_id": emitter.get_instance_id() }
...
func add_listener(signal_name: String, listener: Object, method: String) -> void:
	var listener_data: Dictionary = { "object": listener, "object_id": listener.get_instance_id(), "method": method }
...
func _process_purge(data: Dictionary, group: Dictionary) -> bool:
	var object_exists: bool = !!weakref(data.object).get_ref() and is_instance_valid(data.object)
...
func remove_emitter(signal_name: String, emitter: Object) -> void:
	...
	if _listeners.has(signal_name):
		for listener: Dictionary in _listeners[signal_name].values():
...
func remove_listener(signal_name: String, listener: Object, method: String) -> void:
	...
	if _emitters.has(signal_name):
		for emitter: Dictionary in _emitters[signal_name].values():
